...
const BannerPrimary = ({ text, className }) => {
  return (
    ...
    >
      <div className={`max-w-[1440px] w-[90%] mx-auto flex md:flex-col flex-row md:gap-5 items-start justify-start md:h-[25vh] md:translate-x-20 ${className} `}>
        ...
        <Line className="bg-gradient  md:h-0.5 h-[450px] md:ml-[0] ml-[132px] w-0.5 md:w-full md:hidden" />
        <div
          className="bg-cover bg-no-repeat flex md:flex-1 flex-col items-center justify-center md:ml-[0] ml-[2%] pb-[58px] md:px-5 px-[58px] w-full md:w-[50%] inset-0 md:mx-auto "
          style={{
